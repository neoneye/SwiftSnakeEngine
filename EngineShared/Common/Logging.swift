// MIT license. Copyright (c) 2020 SwiftSnakeEngine. All rights reserved.
import Foundation
import SwiftyBeaver
...
public class LogHelper {
	...
	public static func setup_mainExecutable() {
		...
		let value: String = ProcessInfo.processInfo.environment["SWIFTSNAKEENGINE_RUN_IN_DEBUGGER"] ?? ""
